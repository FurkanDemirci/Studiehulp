    ...
    <nav class="teal lighten-1" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="../index.php" class="brand-logo"><b>ROC Ter
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="../tabs/student.php">Student</a></li>
                <li><a href="../tabs/begeleider.php">Begeleider</a></li>
            ...
            <ul id="nav-mobile" class="side-nav">
                ...
                <li><a class="waves-effect" href="../tabs/student.php"><i class="material-icons">subject</i>Student</a>
                </li>
                <li><a class="waves-effect" href="../tabs/begeleider.php"><i class="material-icons">assignment</i>Begeleider</a>
                </li>
                <li>
                    <div class="divider"></div>
                </li>
                <li><a class="subheader">Account</a></li>
                <li><a class="waves-effect" href="../tabs/login.php"><i class="material-icons">supervisor_account</i>Login
                        / Registreren</a>
                </li>
            </ul>
