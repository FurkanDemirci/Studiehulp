    ...
    <div class="container">
        ...
        <div class="row center">
            ...
            if (isset($_SESSION['user'])) {
                ...
                echo '<a class="btn-large hoverable waves-effect waves-light teal darken-4" href="login.php">Naar Login</a>';
            }
            ?>
        </div>
        <br>
    ...
    <div class="row container">
        ...
        <div class="col s12 m4">
            <div class="icon-block">
                ...
                <p id="indexText" class="light center">Bewerk je preferenties over de 6 categorieën. Zodra de data opgeslagen is,
